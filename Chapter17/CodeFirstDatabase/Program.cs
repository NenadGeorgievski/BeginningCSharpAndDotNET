...
using(var db = new BookContext())
{
    ...
    foreach (var store in query)
    {
        ...
        {
            WriteLine($"-Title:{stock.Item.Title} code: {stock.Item.Code}");
...
public class BookContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-50NLGVU;Database=Books;Integrated Security=True");
    }
}